...
.field mCallbackHandler:Landroid/support/v4/media/session/x;
...
.field mSessionImpl:Ljava/lang/ref/WeakReference;
    ...
    .annotation system Ldalvik/annotation/Signature;
        value = {
            ...
            "Landroid/support/v4/media/session/z;",
            ">;"
        }
    .end annotation
.end field
...
.method public constructor <init>()V
    ...
    .line 12
    .line 13
    invoke-direct {v0, p0}, Landroid/support/v4/media/session/y;-><init>(Landroid/support/v4/media/session/MediaSessionCompat$a;)V
...
# virtual methods
.method public handleMediaPlayPauseIfPendingOnHandler(Landroid/support/v4/media/session/z;Landroid/os/Handler;)V
    .locals 8
    ...
    .line 12
    .line 13
    invoke-interface {p1}, Landroid/support/v4/media/session/z;->getPlaybackState()Landroid/support/v4/media/session/PlaybackStateCompat;
...
.method public onMediaButtonEvent(Landroid/content/Intent;)Z
    ...
    .line 18
    check-cast v1, Landroid/support/v4/media/session/z;

    .line 19
    .line 20
    iget-object v3, p0, Landroid/support/v4/media/session/MediaSessionCompat$a;->mCallbackHandler:Landroid/support/v4/media/session/x;
    ...
    .line 45
    :cond_2
    invoke-interface {v1}, Landroid/support/v4/media/session/z;->f()Landroidx/media/MediaSessionManager$RemoteUserInfo;
    ...
    .line 60
    .line 61
    invoke-virtual {p0, v1, v3}, Landroid/support/v4/media/session/MediaSessionCompat$a;->handleMediaPlayPauseIfPendingOnHandler(Landroid/support/v4/media/session/z;Landroid/os/Handler;)V
    ...
    .line 80
    .line 81
    invoke-interface {v1}, Landroid/support/v4/media/session/z;->getPlaybackState()Landroid/support/v4/media/session/PlaybackStateCompat;
...
.method public setSessionImpl(Landroid/support/v4/media/session/z;Landroid/os/Handler;)V
    .locals 3
    ...
    .line 10
    .line 11
    iget-object v1, p0, Landroid/support/v4/media/session/MediaSessionCompat$a;->mCallbackHandler:Landroid/support/v4/media/session/x;
    ...
    .line 27
    :cond_1
    new-instance v2, Landroid/support/v4/media/session/x;
    ...
    .line 33
    invoke-direct {v2, p0, p1}, Landroid/support/v4/media/session/x;-><init>(Landroid/support/v4/media/session/MediaSessionCompat$a;Landroid/os/Looper;)V
    ...
    :cond_2
    :goto_1
    iput-object v2, p0, Landroid/support/v4/media/session/MediaSessionCompat$a;->mCallbackHandler:Landroid/support/v4/media/session/x;
