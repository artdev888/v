...
.method public final a(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 11
    .line 12
    const-string p3, " FROM blockednumbers LEFT OUTER JOIN vibernumbers ON ([vibernumbers].[member_id]=[blockednumbers].[canonized_number]) LEFT OUTER JOIN phonebookdata ON ([vibernumbers].[canonized_number]=[phonebookdata].[data2] OR [blockednumbers].[canonized_number]=[phonebookdata].[data2]) LEFT OUTER JOIN phonebookcontact ON ([phonebookdata].[contact_id]=[phonebookcontact].[_id]) "
    ...
    .line 33
    :cond_0
    const-string p1, " GROUP BY [blockednumbers].[canonized_number] "
