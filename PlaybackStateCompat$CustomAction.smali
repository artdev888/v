...
.method public static fromCustomAction(Ljava/lang/Object;)Landroid/support/v4/media/session/PlaybackStateCompat$CustomAction;
    ...
    .line 4
    .line 5
    invoke-static {p0}, Landroid/support/v4/media/session/G;->l(Landroid/media/session/PlaybackState$CustomAction;)Landroid/os/Bundle;
    ...
    .line 13
    .line 14
    invoke-static {p0}, Landroid/support/v4/media/session/G;->f(Landroid/media/session/PlaybackState$CustomAction;)Ljava/lang/String;
    ...
    .line 18
    invoke-static {p0}, Landroid/support/v4/media/session/G;->o(Landroid/media/session/PlaybackState$CustomAction;)Ljava/lang/CharSequence;
    ...
    .line 22
    invoke-static {p0}, Landroid/support/v4/media/session/G;->m(Landroid/media/session/PlaybackState$CustomAction;)I
...
.method public getCustomAction()Ljava/lang/Object;
    ...
    .line 10
    .line 11
    invoke-static {v0, v1, v2}, Landroid/support/v4/media/session/G;->e(Ljava/lang/String;Ljava/lang/CharSequence;I)Landroid/media/session/PlaybackState$CustomAction$Builder;
    ...
    .line 16
    .line 17
    invoke-static {v0, v1}, Landroid/support/v4/media/session/G;->w(Landroid/media/session/PlaybackState$CustomAction$Builder;Landroid/os/Bundle;)V

    .line 18
    .line 19
    .line 20
    invoke-static {v0}, Landroid/support/v4/media/session/G;->b(Landroid/media/session/PlaybackState$CustomAction$Builder;)Landroid/media/session/PlaybackState$CustomAction;
