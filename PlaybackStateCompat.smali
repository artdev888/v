...
.method public static fromPlaybackState(Ljava/lang/Object;)Landroid/support/v4/media/session/PlaybackStateCompat;
    ...
    .line 7
    .line 8
    invoke-static {v1}, Landroid/support/v4/media/session/G;->j(Landroid/media/session/PlaybackState;)Ljava/util/List;
    ...
    .line 55
    .line 56
    invoke-static {v1}, Landroid/support/v4/media/session/H;->a(Landroid/media/session/PlaybackState;)Landroid/os/Bundle;
    ...
    .line 68
    invoke-static {v1}, Landroid/support/v4/media/session/G;->r(Landroid/media/session/PlaybackState;)I
    ...
    .line 72
    invoke-static {v1}, Landroid/support/v4/media/session/G;->q(Landroid/media/session/PlaybackState;)J
    ...
    .line 76
    invoke-static {v1}, Landroid/support/v4/media/session/G;->i(Landroid/media/session/PlaybackState;)J
    ...
    .line 80
    invoke-static {v1}, Landroid/support/v4/media/session/G;->p(Landroid/media/session/PlaybackState;)F
    ...
    .line 84
    invoke-static {v1}, Landroid/support/v4/media/session/G;->g(Landroid/media/session/PlaybackState;)J
    ...
    .line 88
    invoke-static {v1}, Landroid/support/v4/media/session/G;->k(Landroid/media/session/PlaybackState;)Ljava/lang/CharSequence;
    ...
    .line 92
    invoke-static {v1}, Landroid/support/v4/media/session/G;->n(Landroid/media/session/PlaybackState;)J
    ...
    .line 96
    invoke-static {v1}, Landroid/support/v4/media/session/G;->h(Landroid/media/session/PlaybackState;)J
...
.method public getPlaybackState()Ljava/lang/Object;
    ...
    .line 4
    .line 5
    invoke-static {}, Landroid/support/v4/media/session/G;->d()Landroid/media/session/PlaybackState$Builder;
    ...
    .line 18
    invoke-static/range {v1 .. v7}, Landroid/support/v4/media/session/G;->x(Landroid/media/session/PlaybackState$Builder;IJFJ)V
    ...
    .line 22
    .line 23
    invoke-static {v0, v1, v2}, Landroid/support/v4/media/session/G;->u(Landroid/media/session/PlaybackState$Builder;J)V
    ...
    .line 27
    .line 28
    invoke-static {v0, v1, v2}, Landroid/support/v4/media/session/G;->s(Landroid/media/session/PlaybackState$Builder;J)V
    ...
    .line 32
    .line 33
    invoke-static {v0, v1}, Landroid/support/v4/media/session/G;->v(Landroid/media/session/PlaybackState$Builder;Ljava/lang/CharSequence;)V
    ...
    .line 59
    .line 60
    invoke-static {v0, v2}, Landroid/support/v4/media/session/G;->a(Landroid/media/session/PlaybackState$Builder;Landroid/media/session/PlaybackState$CustomAction;)V
    ...
    .line 65
    .line 66
    invoke-static {v0, v1, v2}, Landroid/support/v4/media/session/G;->t(Landroid/media/session/PlaybackState$Builder;J)V
    ...
    .line 76
    .line 77
    invoke-static {v0, v1}, Landroid/support/v4/media/session/H;->b(Landroid/media/session/PlaybackState$Builder;Landroid/os/Bundle;)V

    .line 78
    .line 79
    .line 80
    :cond_1
    invoke-static {v0}, Landroid/support/v4/media/session/G;->c(Landroid/media/session/PlaybackState$Builder;)Landroid/media/session/PlaybackState;
...
.method public toString()Ljava/lang/String;
    ...
    .line 101
    .line 102
    invoke-static {v0, v1, v2, v3}, LVe0/l;->q(Ljava/lang/StringBuilder;JLjava/lang/String;)Ljava/lang/String;
